class Dustbin {
    ...
    constructor(){
        this.bin1=Bodies.rectangle(650,370,200,20,{isStatic:true})
        this.bin2=Bodies.rectangle(560,310,20,100,{isStatic:true})
        this.bin3=Bodies.rectangle(740,310,20,100,{isStatic:true})
